...
function Quiz() {
  ...
  return (
    ...
    >
      ...
      <section className="w-full h-full flex flex-col items-center xl:px-4 md:py-2 px-0 py-1 gap-4 md:gap-8 ">
        {isLoading ? (
          <div className="w-full h-full flex items-center justify-center">
            <span className="sr-only">Loading...</span>
          ...
          <>
            <div className="h-full md:w-[90%] w-full flex flex-col items-center gap-6 ">
